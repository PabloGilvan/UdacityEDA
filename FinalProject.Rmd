'---
title: "Analisando Conjunto de dados da Polícia Rodoviária Federal: Infrações e Acidentes em Rodovias Federais"
output: html_notebook
---

Achei interessante trabalhar com tal conjuntos de dados, visto que os mesmos apresentam dados registrados pela entidade responsável por
fiscalizar e manter a ordem nas rodovias federais de todo o país.

Trabalha-se com dois conjuntos de dados principais:

1 - Infrações de Trãnsito:
  Arquivo: "dez.csv"
...
2 - Acidentes Agrupados por ocorrência:
  Arquivo: "datatran2018.csv"
  Link: https://www1.prf.gov.br/arquivos/index.php/s/MaC6cieXSFACNWT
  Período: ano de 2018
  Dicionário de dados: encontra-se no PDF "Dicionário de Variáveis_ocorrencia_2017.pdf", ou no
                       link: https://www1.prf.gov.br/arquivos/index.php/s/9JIz6yPXT71l9Gf#pdfviewer
...
Identificar quais rodovías(Kms/Região) são mais perigosas e se trechos com maior número de infrações registradas remetem a trechos mais perigosos e por isso uma fiscalização mais intensa ou se trechos com mais registros de infrações são trechos com menos acidentes por serem mais fiscalizados? 
...
```{r}
print(cat('Tipo.: ', typeof(infracoes$dat_infracao)))
